...
#include "TestForgeTestComparisonMethod.h"
#include <CoreMinimal.h>
#include <Kismet/BlueprintFunctionLibrary.h>
#include "TestForgeTestAssertBlueprintFunctionLibrary.generated.h"
...
UCLASS(meta = (RestrictedToClasses = "TestForgeTestActor,TestForgeUnitTest"))
class TESTFORGE_API UTestForgeTestAssertBlueprintFunctionLibrary
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "TestAutomation|Assert",
              meta = (HidePin = "Context", DefaultToSelf = "Context"))
    static void AssertFail(const FString& What, UObject* Context = nullptr);

    /** Expects the specified value to be true. TODO(rj): Change const FString& What to FText so text format can be applied. */
    UFUNCTION(BlueprintCallable, Category = "TestAutomation|Assert",
              meta = (HidePin = "Context", DefaultToSelf = "Context"))
    ...
    UFUNCTION(BlueprintCallable, Category = "TestAutomation|Assert",
              meta = (HidePin = "Context", DefaultToSelf = "Context"))
    static void AssertWasTriggered(ATestForgeTestTriggerBox* TestTriggerBox, UObject* Context = nullptr);

    /** Expects the specified trigger box not to be triggered. */
    UFUNCTION(BlueprintCallable, Category = "TestAutomation|Assert",
              meta = (HidePin = "Context", DefaultToSelf = "Context"))
    static void AssertWasNotTriggered(ATestForgeTestTriggerBox* TestTriggerBox,
    ...
    static void AssertCompareByte(uint8 First, ETestForgeTestComparisonMethod ShouldBe, uint8 Second,
    ...
    static void AssertCompareInt32(int32 First, ETestForgeTestComparisonMethod ShouldBe, int32 Second,
                                   const FString& What, UObject* Context = nullptr);
    ...
    static void AssertCompareInt64(int64 First, ETestForgeTestComparisonMethod ShouldBe, int64 Second,
                                   const FString& What, UObject* Context = nullptr);
    ...
    static void AssertCompareFloat(float First, ETestForgeTestComparisonMethod ShouldBe, float Second,
                                   const FString& What, UObject* Context = nullptr);
...
private:
    ...
    static void AssertCompare(UObject* Context, const FString& What, T First,
                              ETestForgeTestComparisonMethod ShouldBe, T Second)
    {
        bool bFulfilled = false;

        switch (ShouldBe)
        {
            case ETestForgeTestComparisonMethod::LessThan:
                bFulfilled = First < Second;
                break;

            case ETestForgeTestComparisonMethod::LessThanOrEqualTo:
                bFulfilled = First <= Second;
                break;

            case ETestForgeTestComparisonMethod::GreaterThanOrEqualTo:
                bFulfilled = First >= Second;
                break;

            case ETestForgeTestComparisonMethod::GreaterThan:
                bFulfilled = First > Second;
                break;
        }
